...
def get_data(data_dir, batch_size):
    ...
    root_test = osp.join(data_dir, 't')
    data_file = open(osp.join(data_dir, 't_list.txt'))
    ...
    test_loader = DataLoader(
        TestSet(test_set, root=root_test, transform=test_transforms),
        batch_size=batch_size, shuffle=False, pin_memory=True
    )
    test_cls_list, test_attrs = get_test_attrs()
    print('get train data loader')
    return train_loader, test_loader, test_cls_list, test_attrs
...
def main(args):
    ...
    train_loader, test_loader, test_cls_list, test_attrs = get_data(args.data_dir, args.batch_size)
